...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<script>
				function addToCart(){
					$.get("/portal/cart/add.do?productId=${productVO.id}",function(data,status){
						alert("数据：" + data + "\n状态：" + status);
					});
				});
		</script>
			...
			<div class="nav-table">
				...
				<div class="item-inform">
					...
					<div class="clearfixRight">
						...
						<div class="tb-detail-list">
							...
							<div class="tb-detail-price">
								...
								<li class="price iteminfo_mktprice">
									<dt>原价</dt>
									<dd><em>¥</em><b class="sys_item_mktprice">${productVO.price}</b></dd>
								</li>
								<div class="clear"></div>
							</div>
						...
						<div class="pay">
							<div class="pay-opt">
							<a href="home.ftl"><span class="am-icon-home am-icon-fw">首页</span></a>
							...
							<li>
								<div class="clearfix tb-btn tb-btn-basket theme-login">
									<a id="LikBasket" title="加入购物车" href="#" onclick="addToCart"><i></i>加入购物车</a>
								</div>
							</li>
						</div>
